...
create_salty_authentication: create_salty_authentication.o io.o md5.o misc.o rand_utils.o sha1.o ui.o auth_file.o authenticate_common.o create_authentication_common.o all_password_enumerator.o alphabet_phrase_generator.o dictionary.o dictionary_word_generator.o mixed_cased_dictionary_word_generator.o password_enumerator.o password_generator.o password_part_generator.o random_password_enumerator.o rule_segment.o single_cased_dictionary_word_generator.o
	gcc -ansi -pedantic-errors -g -lm -o create_salty_authentication create_salty_authentication.o io.o md5.o misc.o rand_utils.o sha1.o ui.o auth_file.o authenticate_common.o create_authentication_common.o all_password_enumerator.o alphabet_phrase_generator.o dictionary.o dictionary_word_generator.o mixed_cased_dictionary_word_generator.o password_enumerator.o password_generator.o password_part_generator.o random_password_enumerator.o rule_segment.o single_cased_dictionary_word_generator.o

authenticate: authenticate.o io.o md5.o misc.o rand_utils.o sha1.o ui.o auth_file.o authenticate_common.o create_authentication_common.o all_password_enumerator.o alphabet_phrase_generator.o dictionary.o dictionary_word_generator.o mixed_cased_dictionary_word_generator.o password_enumerator.o password_generator.o password_part_generator.o random_password_enumerator.o rule_segment.o single_cased_dictionary_word_generator.o
	gcc -ansi -pedantic-errors -g -lm -o authenticate authenticate.o io.o md5.o misc.o rand_utils.o sha1.o ui.o auth_file.o authenticate_common.o create_authentication_common.o all_password_enumerator.o alphabet_phrase_generator.o dictionary.o dictionary_word_generator.o mixed_cased_dictionary_word_generator.o password_enumerator.o password_generator.o password_part_generator.o random_password_enumerator.o rule_segment.o single_cased_dictionary_word_generator.o
