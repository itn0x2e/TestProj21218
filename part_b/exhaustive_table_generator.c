...
bool_t generateExaustiveTable(passwordEnumerator_t * enumerator,
	...
	return RT_generate(enumerator,generator, enumeratorPassword, generatorPassword, hashFunc,
			...
			prefix /*const char * hashTableFilePrefix*/,
			TABLE_OF_POINTERS_ENTRIES/*ulong_t nHashTableEntries*/,
			PAIRS_PER_BLOCK/*ulong_t nPairsPerBlock*/,
			FALSE/*bool_t enableFirstBlockCache*/,
			FALSE/*bool_t enableLastBlockCache*/
			);
}